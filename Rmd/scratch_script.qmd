...
download.file(
  url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2017/010_archv.2017_003_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=23&west=-90&east=-89.8&south=22.8&horizStride=1&vertCoord=0.0&accept=netcdf4",
  destfile = here(dwnld_path, "test_no_time.nc4"),
  method = "curl"
  )

download.file(
  url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_04_3z.nc?disableLLSubset=on&disableProjSubset=on&horizStride=1&time=&vertCoord=&accept=netcdf4",
...
httr::HEAD("https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2017/010_archv.2017_003_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=23&west=-90.5&east=-89&south=22.5&horizStride=1&time=2017-01-03T12%3A00%3A00Z&vertCoord=1.7&accept=netcdf4") %>%
  httr::status_code()

shelf(curl)
handle <- curl::new_handle()
curl::curl_fetch_memory("https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2017/010_archv.2017_003_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=23&west=-90.5&east=-89&south=22.5&horizStride=1&time=2017-01-03T12%3A00%3A00Z&vertCoord=1.7&accept=netcdf4", handle)
```
...
# hycom_url <- "https://data.hycom.org/datasets/GOMb0.01/reanalysis/data/"
...
# write_csv(test5, here(rstudioapi::selectDirectory(), "hycom_100deg_download_instructions.csv"))
...
# https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/{year}/
# https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc/dataset.html


download.file(
  # url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_04_3z.nc?disableLLSubset=on&disableProjSubset=on&horizStride=1&time=&vertCoord=&accept=netcdf4",
  url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2020/023_archv.2020_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.5&south=25.5&disableProjSubset=on&horizStride=5&time=2020-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4",
  destfile = here(dwnld_path, "test8.nc4"),
  method = "curl"
  )
"https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.7&south=25.95&disableProjSubset=on&horizStride=5&time=2019-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4"
"https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.7&south=25.95&disableProjSubset=on&horizStride=1&time=2019-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4"
# "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.5&south=25.8&horizStride=5&time=2019-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4"

"https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.7&south=25.95&disableProjSubset=on&horizStride=1&time=2019-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4"

download.file(
  # url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_04_3z.nc?disableLLSubset=on&disableProjSubset=on&horizStride=1&time=&vertCoord=&accept=netcdf4",
url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.5&south=25.8&horizStride=5&time=2019-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4",
  # url = "https://ncss.hycom.org/thredds/ncss/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc?var=salinity&var=u&var=v&var=w_velocity&var=water_temp&north=26&west=-83.812&east=-83.7&south=25.95&disableProjSubset=on&horizStride=5&time=2019-01-01T12%3A00%3A00Z&vertCoord=0.0&accept=netcdf4",
  destfile = here(dwnld_path, "test7.nc4"),
  method = "curl"
  )
```
...
```{r}
hycom_yr_url <-
"https://tds.hycom.org/thredds/catalog/datasets/GOMb0.01/reanalysis/data/2023/"

test <-
  paste0(hycom_yr_url, "catalog.html") %>%
  read_html() %>%
  html_element("body") %>% 
  html_table() %>%
  pull(1) %>%
  str_subset("12_3z\\.nc") %>%
  tibble(file = hycom_yr_url, day = .) %>%
  mutate(
    part_url = str_extract(file, "datasets/GO.*"),
    file_day = paste0(file, "catalog.html?dataset=", part_url, day)
  )
...
test2 <- 
  # "https://tds.hycom.org/thredds/catalog/datasets/GOMb0.01/reanalysis/data/2023/catalog.html?dataset=datasets/GOMb0.01/reanalysis/data/2023/023_archv.2019_001_12_3z.nc" %>%
  # "https://tds.hycom.org/thredds/catalog/datasets/GOMb0.01/reanalysis/data/2019/catalog.html?dataset=datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc"

  # "https://tds.hycom.org/thredds/catalog/datasets/GOMb0.01/reanalysis/data/2023/catalog.html?dataset=datasets/GOMb0.01/reanalysis/data/2023/023_archv.2023_004_12_3z.nc" %>%
 read_html() 
...
"https://ncss.hycom.org/thredds/ncss/grid/datasets/GOMb0.01/reanalysis/data/2019/023_archv.2019_001_12_3z.nc/dataset.html" %>%
 read_html() %>%
 html_element("body") %>%
 html_elements("h3 span") %>%
 html_text() %>%
...
<https://github.com/sherrypalacios/PHYDOTax>

From: Testing a Hyperspectral, Bio‐Optic al Approach to Identification of Phytoplankton Community Composition in the Chesapeake Bay Estuary

```{r}
rrs_path <- rstudioapi::selectFile() 
rrs_path <- here::here("data", "raw", "phydotax") |>
  fs::dir_ls()

librarian::shelf(librarian, ncdf4)


rrs_nc <- nc_open(rrs_path[1])
print(rrs_nc)

attributes(rrs_nc$var)
attributes(rrs_nc$dim)

ncvar_get(rrs_nc, "__xarray_dataarray_variable__")[,,]
ncvar_get(rrs_nc, "z_number_components")
ncvar_get(rrs_nc, "y_mixture_run_num")
ncvar_get(rrs_nc, "x_phytotype")
rrs_nc$var$`__xarray_dataarray_variable__`

nc_close(rrs_nc)

rrs_unk <- rstudioapi::selectFile()

rrs_unk_nc <- nc_open(rrs_unk[2])
print(rrs_unk_nc)

attributes(rrs_unk_nc$var)
attributes(rrs_unk_nc$dim)

ncvar_get(rrs_unk_nc, "__xarray_dataarray_variable__")[,,] 
ncvar_get(rrs_unk_nc, "z_number_components")
ncvar_get(rrs_unk_nc, "y_wavelength")
ncvar_get(rrs_unk_nc, "x_mixture_run_num")
rrs_unk_nc$var$`__xarray_dataarray_variable__`$dim
...
NEEDS: wgrib2 external dependency

```{r}
# shelf(rNOMADS)
# 
# era_path <- rstudioapi::selectFile()
# 
# data <- ReadGrib(
#   file.names = era_path
...
# Robust ANOVA Trimmed Mean

Trimmed mean: cuts the top and bottom x percent of values
- ex if 0.1 (10%) than 5% at bottom and 5% at top or 5% < x < 95%

Example from: <https://metricgate.com/docs/robust-anova-trimmed-means/>
Reasons to use:
whenever the assumptions behind classical ANOVA look fragile:
  * Boxplots or QQ plots show outliers, heavy tails, or skewness.
  * Group variances are clearly unequal
  * Sample sizes per group are small, so you cannot rely on the central limit theorem.
  * Skewed measurements such as response times, incomes, or biological assay readouts.
  * You want one procedure that simultaneously handles location and scale problems.
  
interpret:
  * xi (explanatory effect size): reports magnitude on a 0-1 scale; values near 1 indicate large group separation.
  
  
```{r}
librarian::shelf(quiet = TRUE, WRS2)

data("iris")
iris

# jamovi version 
result <- walrus::ranova(
  data    = WRS2::goggles,
  dep     = "attractiveness",       # dependent variable (numeric)
  factors = c("gender"), # independent variables (factors)
  method  = "trim",                  # "trim" (default), "median", or "boot"
  ph      = TRUE,                    # post-hoc tests
  tr      = 0.2                      # trim proportion (20%)
)
# View main ANOVA table
result$main$asDF

# View post-hoc results
result$phs$asDF

re <- WRS2::t1way(attractiveness ~ gender, data = WRS2::goggles)
re$Qb
# robust ANOVA (trimmed means 20%)
res <- WRS2::t1way(Sepal.Length ~ Species, data = iris, tr = 0.2)
F_stat  <- as.numeric(res$test)
df1_val <- as.numeric(res$df1)
df2_val <- as.numeric(res$df2)
p_val   <- as.numeric(res$p.value)
xi_val  <- if (!is.null(res$effsize)) as.numeric(res$effsize) else NA_real_
res

# Robust Bootstrapped for small datasets
res2 <- WRS2::t1waybt(Sepal.Length ~ Species, data = iris, tr = 0.2)
res2$test
res2$Effect.Size
res2$p.value
...
aov_sum <- summary(aov_fit)[[1]]
  F_cl   <- aov_sum[["F value"]][1]
  p_cl   <- aov_sum[["Pr(>F)"]][1]
  df1_cl <- aov_sum[["Df"]][1]
  df2_cl <- aov_sum[["Df"]][2]
cat(sprintf("  Classical F = %.4f, df1 = %.2f, df2 = %.2f, p = %.6g\n",
              F_cl, df1_cl, df2_cl, p_cl))

cat(sprintf("  Robust    F = %.4f, df1 = %.2f, df2 = %.2f, p = %.6g\n",
              F_stat, df1_val, df2_val, p_val))

rm(list = ls())

# librarian::unshelf(WRS2)

timevec <- c(77, 87, 88, 114, 151, 210, 219, 
  246, 253, 262, 296, 299, 306, 
...
# manual timmed mean 
quant <- quantile(timevec, c(0.05, 0.95)) # 10% - 5% at each end
mean(timevec[timevec > quant[1] & timevec < quant[2]])

# trimmed mean
mean(timevec, 0.1)
# trimmed se
WRS2::trimse(timevec, 0.1)

median(timevec)
WRS2::msmedse(timevec)
...
result <- walrus::ranova(
  data    = WRS2::goggles,
  dep     = "attractiveness",       # dependent variable (numeric)
  factors = c("gender", "alcohol"), # independent variables (factors)
  method  = "trim",                  # "trim" (default), "median", or "boot"
  ph      = TRUE,                    # post-hoc tests
  tr      = 0.2                      # trim proportion (20%)
)
...
biomass_dat <- 
  ...
  filter(str_detect(upper_lower,  "Main Creeks|Upper|Lower")) %T>% 
  print()
...
dbh_height <- biomass_dat %>%
  filter(str_detect(species, "mangle")) %>%
  lm(height_m ~ dbh_cm, data = .)
summary(dbh_height)

biomass_dat %>%
  filter(str_detect(species, "mangle")) %>%
  ggplot(aes(x = dbh_cm, y = height_m)) +
  geom_smooth(method = "lm", fill = "#9cb8ea") +
  geom_point(color = "#9cb8ea") +
  labs(
    x = "dbh (cm)",
    y = "Height (m)",
...
shelf(terra) 
  (here("data", "raw", "placencia") %>%
  dir_ls(regexp = "placencia_mangrove_map_interp.*tiff") )[3] %>%
  rast() %>%
  # plot()
  global(fun = c("sum", "mean", "min", "max"), na.rm = TRUE) %>%
  mutate(sum = sum /1000)
```
