...
df1 <- data.frame(
  x = 1:20,
  y = c(0.1, 0.2, 0.4, 0.7, 1, 1.5, 2, 3, 4, 5,
        8, 10, 15, 20, 30, 50, 100, 200, 500, 1000)
)
...
# Rescale Color Gradient in ggplot2 
Sep 05, 2025

Within scale_x_gradientn, can set the midpoint using argument `rescaler` 
- ex: `rescaler = ~ scales::rescale_mid(.x, mid = 0)`
...
data_2 |>
  ...
  scale_fill_gradientn(
    colours = c('#709AE1', '#FFFFFF', '#FD7446'),
    rescaler = ~ scales::rescale_mid(.x, mid = -3),
    limits = c(-4, 0))
