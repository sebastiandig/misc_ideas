...
# ============================================================================ #
# ---- `prefixer::count_calls`: Convert .Rmd or Qmd to .R file to use ----
# ============================================================================ #
# Jul 11, 2024

# from <https://stackoverflow.com/questions/71183578/how-to-extract-all-code-from-an-rmarkdown-rmd-file>
# checks the number of function calls and to which packages the functions are
# called from
...
# ============================================================================ #
# ---- Using `if` Statements in `list()` call ----
# ============================================================================ #
# Mar 06, 2025
# Allows to include in list using `if` statement
{
  message("x1 = 1")
  x1 <- 1
  list(
